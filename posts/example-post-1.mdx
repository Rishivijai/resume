...
description: |-
  Aspiring Data Scientist with practical experience in machine learning, data
   analytics, and model deployment. Proficient in predictive analytics, data
   visualization, and MLOps, with a strong programming foundation and a passion for
